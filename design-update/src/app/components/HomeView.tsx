...
import seasonImage from 'figma:asset/46d1be35a15241b86f79a1da4d3b188211996a41.png';
import hostImage from 'figma:asset/4dadc749371545dfaa717f63881e0f372cea65db.png';

export function HomeView({ onJoinClick, onOverviewClick }: { onJoinClick: () => void; onOverviewClick: () => void }) {
  return (
    <div className="pt-24">
      {/* Hero Section */}
      <section className="min-h-[90vh] flex flex-col items-center justify-center text-center px-6 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl space-y-12">
          <h2 className="font-['Pinyon_Script'] text-[#FFC83D] text-4xl md:text-5xl">Welcome to the Edit</h2>
          <h1 className="font-serif text-6xl md:text-8xl lg:text-9xl text-white leading-none tracking-tight">
            BEING <br />
            <span className="italic font-light">HEALED.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 pt-8">
            ...
            <button 
              onClick={() => {
                // This would normally scroll to an episodes section or change tab
                // For now we'll keep it as a button that could link to the episodes tab
              }}
